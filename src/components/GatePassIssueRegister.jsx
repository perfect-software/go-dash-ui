...
const GatePassIssueRegister = () => {
  ...
  const options = [
    {
      name: "Gate Pass Issue Register",
      details: "Maintain records of all issued gate passes.",
    },
    {
      name: "Job Work Register",
      details: "Track and manage job work orders and their progress.",
    },
    {
      name: "List of Pending Gate Pass",
      details:
        "View all gate passes that are still pending approval or completion.",
    },
  ];
    ...
    <div className={styles.pOMainContainer}>
      <div className={styles.pOSubContainer}>
        <div className={styles.titleContainer}>
          <h1>Gate Pass Issue Register</h1>
        </div>
...
export default GatePassIssueRegister;
