        ...
        <div className={styles.topHeader}>
          <div className={styles.leftDiv}>
            {isSmallScreen ? (
              ...
              <div>
                <img onClick={()=>navigate('/')} className={styles.logoImg} src={Logo} alt="Company Logo" />
              </div>
            )}
          </div>
          ...
          <div className={styles.rightDiv}>
            {isCore ? (
              ...
              // </div>
              <button className={buttonstyles.buttonpushable}  onClick={() => setIsCore(!isCore)} >
              <span className={buttonstyles.buttonshadow}></span>
              <span className={buttonstyles.buttonedge}></span>
              <span className={`${buttonstyles.buttonfront} ${buttonstyles.text}` } style={{background:'#FF5722'}}>
                Core
              </span>
              </button>
            ) : (
              ...
              <span className={buttonstyles.buttonshadow}></span>
              <span className={buttonstyles.buttonedge}></span>
              <span className={`${buttonstyles.buttonfront} ${buttonstyles.text}`} >
                Analytics
              </span>
              </button>
            )}
